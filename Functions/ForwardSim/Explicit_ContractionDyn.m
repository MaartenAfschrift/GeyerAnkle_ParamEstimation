function [dlMtildedt,FT] = Explicit_ContractionDyn(a,lMtilde,lMT,params,ATendon,shift,varargin)
% Explicit_ContractionDyn Computes time derivative of the normalised muscle
% fiber length.
% inputs:
%   a: muscle activation
...
%   varargin:
%       (1) time step integrator
%       (2) maximal norm fiber velocity

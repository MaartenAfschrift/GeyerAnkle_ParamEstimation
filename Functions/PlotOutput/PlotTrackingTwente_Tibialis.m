...
for i=1:nPhase
    ...
    plot(All_GeyerDefault.t(iSel) + t0,full(All_GeyerDefault.x(2,iSel)),'Color',ColGeyer,'LineWidth',lw); hold on;
        
    % COM geyer GRF model shooting
    iSel = All_GeyerCOM_GRF.iDatSet(i)+1:All_GeyerCOM_GRF.iDatSet(i+1);
    plot(All_GeyerCOM_GRF.t(iSel) + t0,full(All_GeyerCOM_GRF.x(2,iSel)),'Color',ColGRF,'LineWidth',lw);
